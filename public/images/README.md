...
- `properties/departamento-moderno-en-surco/propiedad.jpg`
- `properties/departamento-moderno-en-surco/imagen-secundaria.webp`
...
- Mantener una estructura de carpetas lógica por uso: `logo/`, `home/`, `properties/{slug-de-propiedad}/`.
- Guardar las fotos de cada propiedad dentro de `properties/{slug-de-propiedad}/`; la galería del detalle usa esa carpeta para cargar las imágenes reales durante el build.
